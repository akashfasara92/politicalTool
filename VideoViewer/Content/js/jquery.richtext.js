(function ($) {
    $.fn.richText = function (options) {
        ...
        var editorID = "richText-" + $inputElement[0].id;
        ...
        function init() {
            ...
            //var $editorView = $('<div />', { class: "richText-editor", id: editorID, contenteditable: true, "ng-model": "model.receipt_header", "ng-change": "ChangeRichTextboxValue('" + editorID + "')" });
